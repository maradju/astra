...
class mdj_Agencies extends Company
{
    public $new_schema = true;
    public $module_dir = 'mdj_Agencies';
    public $object_name = 'mdj_Agencies';
    public $table_name = 'mdj_agencies';
    ...
    public $first_name_of_intermediary;
    public $last_name_of_intermediary;
    public $type_of_company;
    public $name_of_the_country;
    public $registered_in_apr;
    public $spam;
    public $license;
    public $type_of_work;
    public $destination;
    public $contract;
    public $measures_taken;
    public $responce_to_astra;
