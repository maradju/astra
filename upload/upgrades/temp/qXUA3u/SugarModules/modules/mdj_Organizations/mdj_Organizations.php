...
class mdj_Organizations extends Company
{
    public $new_schema = true;
    public $module_dir = 'mdj_Organizations';
    public $object_name = 'mdj_Organizations';
    public $table_name = 'mdj_organizations';
