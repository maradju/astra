<?php 
 $GLOBALS["dictionary"]["nov_judicial_proceeding"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'nov_judicial_proceeding_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'nov_judicial_proceeding_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'nov_judicial_proceeding_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_nov_judicial_proceeding',
    ...
    array (
      'name' => 'nov_judicial_proceeding_number',
      'vname' => 'LBL_NUMBER',
      'type' => 'int',
      'readonly' => true,
      'len' => 11,
    ...
    array (
      ...
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'nov_judicial_proceeding_type_dom',
      'len' => 100,
    ...
    array (
      ...
      'dbType' => 'datetime',
      'id' => 'nov_judicial_proceedingstart_date_c',
      'custom_module' => 'nov_judicial_proceeding',
    ),
    ...
    array (
      ...
      'enable_range_search' => false,
      'dbType' => 'datetime',
      'id' => 'nov_judicial_proceedingend_date_c',
      'custom_module' => 'nov_judicial_proceeding',
    ),
  ...
  array (
    'id' => 
    array (
      'name' => 'nov_judicial_proceedingpk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'number' => 
    array (
      'name' => 'nov_judicial_proceedingnumk',
      'type' => 'unique',
      'fields' => 
      array (
        0 => 'nov_judicial_proceeding_number',
      ),
    ),
  ),
  'templates' => 
