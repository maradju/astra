<?php 
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    'relationship_with_trader_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Relationship with trafficker',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'relationship_with_trader_c',
      'vname' => 'LBL_RELATIONSHIP_WITH_TRADER',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsrelationship_with_trader_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Accountsfp_event_locations_id_c',
      'custom_module' => 'Accounts',
    ),
    'gender_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_NOV_JUDICIAL_PROCEEDING_ACCOUNTS_1_FROM_NOV_JUDICIAL_PROCEEDING_TITLE',
    ),
    ...
    array (
      ...
      'no_default' => false,
      'comments' => '',
      'help' => 'Check if client is active case',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
    ...
    array (
      ...
      'vname' => 'LBL_MDJ_AGENCIES_ACCOUNTS_1_FROM_MDJ_AGENCIES_TITLE',
    ),
    'experienced_violence_before_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Experienced violence before',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'experienced_violence_before_c',
      'vname' => 'LBL_EXPERIENCED_VIOLENCE_BEFORE',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'experienced_violence_before_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsexperienced_violence_before_c',
      'custom_module' => 'Accounts',
    ),
    'trafficker_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_MDJ_ORGANIZATIONS_ACCOUNTS_1_FROM_MDJ_ORGANIZATIONS_TITLE',
    ),
    'type_of_exploitation_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Type of exploitation c',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'type_of_exploitation_c',
      'vname' => 'LBL_TYPE_OF_EXPLOITATION_C',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountstype_of_exploitation_c',
      'custom_module' => 'Accounts',
    ),
    'person_with_disability_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Person with disability',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'person_with_disability_c',
      'vname' => 'LBL_PERSON_WITH_DISABILITY_C',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'person_with_disability_c_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsperson_with_disability_c',
      'custom_module' => 'Accounts',
    ),
    'last_name_c' => 
    array (
    ...
    array (
      ...
      'module' => 'Calls',
      'bean_name' => 'Call',
      'vname' => 'LBL_CALLS_ACCOUNTS_2_FROM_CALLS_TITLE',
    ),
    'date_of_birth_c' => 
    array (
      'inline_edit' => '1',
    ...
    array (
      ...
      'len' => '36',
      'size' => '20',
      'id' => 'Accountsprospect_id_c',
      'custom_module' => 'Accounts',
    ),
    'way_of_recruitment_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Way of recruitment',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'way_of_recruitment_c',
      'vname' => 'LBL_WAY_OF_RECRUITMENT',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsway_of_recruitment_c',
      'custom_module' => 'Accounts',
    ),
    ...
    array (
      ...
      'no_default' => false,
      'comments' => '',
      'help' => 'Check if proceeding initiated',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsjudicial_proceeding_c',
      'custom_module' => 'Accounts',
    ),
    'marital_status_c' => 
    array (
